  ...
  <div class="container">
       ...
       <div class="row">
         ...
         <div class="col-sm-9">
           ...
           <a href="http://www.cs.gmu.edu/~jessica/sax.htm">Symbolic Aggregate approXimation</a>, that discretizes the input time series into a string,
         ...
         <div class="col-sm-3">
           <img style="margin-top: 20px; margin-bottom: 15px" src="morea/assets/rose-grammar.png" width="200px" class="img-responsive center-block">
         </div>
