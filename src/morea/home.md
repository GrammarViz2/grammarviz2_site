  ...
  <div class="container">
       ...
       <div class="row">
         ...
         <div class="col-sm-9">
           ...
           <p>By exploiting the hierarchical structure of CFG, GrammarViz is able to <em>instantly*</em> identify rare and frequent grammar rules,
           which we associate with anomalous and recurrent subsequences.
           In addition, thanks to SAX numerosity reduction and CFG hierarchy, our approach is able to discover patterns of both types that are of variable
           length in a single run.</p>

           <p><em>* note that the patterns discovery through grammatical inference involves no explicit distance computation</em><br>
           Please find details about our technique here: <a href="http://www2.hawaii.edu/~senin/assets/papers/grammarviz2.pdf">
  ...
  <div class="container">
       ...
       <div class="row">
         ...
         <div class="col-sm-9">
           ...
           <p>GrammarViz 2.0 is developed in Java and can be used interactively through the GUI, called from a command line, or linked to your code
           as a library.
           We followed the Model–view–controller (MVC) pattern in GUI development which allows for code re-use in a web applicaion.
           For your convenience, our code is hosted at <a href="https://github.com/GrammarViz2/grammarviz2_src">GitHub</a>,
           we do Unit test it, analyze with FindBugs and PMD, and use <a href="https://travis-ci.org/GrammarViz2/grammarviz2_src">Travis CI</a>
           for our builds.</p>
         </div>
