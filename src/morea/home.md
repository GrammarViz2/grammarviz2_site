...
<div class="section-background-1" itemscope="" itemtype="http://schema.org/SoftwareApplication">
 <div class="container">
   ...
   <h4><span itemprop="applicationCategory">Open source (<span itemprop="offers">free</span>) time series mining tool based on symbolic approximation and grammatical inference.</span></h4>
