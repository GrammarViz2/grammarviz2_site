...
```text
$ java -cp "target/grammarviz2-3.0.0-jar-with-dependencies.jar" net.seninp.grammarviz.GrammarVizAnomaly
...
```text
$ java -cp "target/grammarviz2-3.0.0-jar-with-dependencies.jar" \
